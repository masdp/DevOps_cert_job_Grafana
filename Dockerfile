...
ADD --from=build /tmp/DevOps_cert_job_Grafana/javamelody-core-1.90.0.jar /usr/local/tomcat/webapps/ROOT/WEB-INF/lib/javamelody-core-1.90.0.jar
ADD --from=build /tmp/DevOps_cert_job_Grafana/jrobin-1.5.9.1.jar /usr/local/tomcat/webapps/ROOT/WEB-INF/lib/jrobin-1.5.9.1.jar
